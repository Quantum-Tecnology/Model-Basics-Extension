...
```
composer require quantumtecnology/model-basics-extension
```
...
- [Validate-Trait](https://packagist.org/packages/quantumtecnology/validate-trait) - Bindar os Requests automaticamente de acordo com o caminho do Model Pattern;
